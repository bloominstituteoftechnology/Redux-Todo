...
import { addTodo, toggleTodo, removeTodos, getTodos} from '../Action';
...
class TodoList extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <form>
                    <input onChange={this.handleTodoInput} name="text" value={this.state.text} />
...
// whatever state is in store, could throw it props inside 
